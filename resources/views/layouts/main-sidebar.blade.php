...
<aside class="app-sidebar sidebar-scroll" style="font-family: 'Cairo', sans-serif; font-size: 30px; font-weight: 700;">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}">Invoices App</a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'home')) }}">Invoices App</a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'home')) }}">Invoices App</a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'home')) }}">Invoices App</a>
    </div>
