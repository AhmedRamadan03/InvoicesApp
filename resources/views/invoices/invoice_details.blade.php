...
@section('content')
    ...
    @if (session()->has('Add'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong style="padding-right: 40px;">{{ session()->get('Add') }}</strong>
    ...
    @if (session()->has('Edit'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong style="padding-right: 40px;">{{ session()->get('Edit') }}</strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    @if (session()->has('delete'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong style="padding-right: 40px;">{{ session()->get('delete') }}</strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="row">
        <div class="panel panel-primary tabs-style-2"
            style=" background-color: #fff; box-shadow: 0 0 2px 0px; width: 100%;">
                            ...
                            <table class="table table-striped" style="text-align:center">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $invoices->categories->cat_name }}</td>
                                    </tr>
