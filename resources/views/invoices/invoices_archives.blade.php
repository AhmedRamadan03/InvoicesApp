        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto" style="font-weight: 900;font-size: 25px">الفواتير</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0" style="font-size: 20px; font-weight: 900;">/ الارشيف
                </span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    @can('ارشفه_الفواتير')
                                                        <a class="dropdown-item " data-target="#Archive_invoice"
                                                            data-invoice_id="{{ $invoice->id }}" data-toggle="modal"
                                                            href="#modaldemo9" title="ألغاء الارشفة"> أرشفة </a>
                                                    @endcan
            ...
            <div class="modal fade" id="Archive_invoice">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">استرجاع الفاتوره</h6><button aria-label="Close"
                        ...
                        <form action="{{ route('archive.update') }}" method="post">
                            @csrf
                            <div class="modal-body">
                                <p>هل انت متاكد من استرجاع هذه الفاتوره ؟</p><br>
                                <input type="hidden" name="id" id="id" value="">
